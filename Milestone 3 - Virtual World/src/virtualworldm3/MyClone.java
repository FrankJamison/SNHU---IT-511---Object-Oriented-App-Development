...
public class MyClone {
    ...
    private static int getNumber (String type) {
        ...
        do {
            // Prompt user for word
            System.out.printf("Please enter your %s", type);
    ...
    private void introduction() {
        System.out.printf("Hello world! My name is %s %s. ", this.getFirstName(),
                this.getLastName());
        System.out.printf("I am a %d-year-old IT Graduate student at SNHU. ", 
                this.getAge());
        ...
        System.out.print("I have a loving wife named Julie and 4 grown children "
                + "named Sarah (25), Jessica (23), Brandon (22), and "
                + "Joshua (22).\n");

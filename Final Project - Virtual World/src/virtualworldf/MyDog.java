...
public class MyDog {
    ...
    private static String getWord (String type) {
        ...
        do {
            ...
            System.out.printf("\nPlease enter your dog's %s: ", type);
    ...
    private String getSelection(String type) {
        ...
        do {
            ...
            if (type == "gender") {
                ...
                isValidInteger = input.matches("^[1-2]$");
            }
            
            if (type == "size") {
                // Limit to 3 selections
                isValidInteger = input.matches("^[1-3]$");
            }
            
            if (type == "hair color" || type == "eye color") {
                // Limit to 8 selections
                isValidInteger = input.matches("^[1-8]$");
            }
    ...
    public void introduction() {
        ...
        System.out.printf("%s is a %d-year-old %s %s. ", 
                this.getName(), this.getAge(), this.getGender(), this.getBreed());
    ...
    public void confirmation() {
        System.out.printf("\nTo confirm, your dog's name is %s. ", this.getName());
        System.out.printf("%s is a %d-year-old %s %s. ", 
                this.getName(), this.getAge(), this.getGender(), this.getBreed());
        System.out.printf("%s has %s hair and %s eyes. ", this.getName(), 
                this.getHairColor(), this.getEyeColor());
